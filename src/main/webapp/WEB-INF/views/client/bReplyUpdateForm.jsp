...
<%@ include file="/WEB-INF/views/common/common.jspf"%>
		...
		$(function() {
			...
			$("#bReplyupdateBtn").click(function(){
				...
				<div class="row">
					...
					<div class="tab-pane fade show active" id="pills-account" role="tabpanel" aria-labelledby="pills-account-tab">
									<form id="replyUpdateForm">
										<input type="hidden" name="br_review_file" id="br_review_file" value="${bReplyUpdate.br_review_file}" />
										<input type="hidden" name="br_review_thumb" id="br_review_thumb" value="${bReplyUpdate.br_review_thumb}" />
										<input type="hidden" name="br_review_no" id="br_review_no" value="${bReplyUpdate.br_review_no}" />
											...
											<div class="account-details">
												<div class="row">
													...
													<div class="col-md-12">
														<div class="single-form">
															<div>상세 리뷰</div>
															<textarea name="br_review_content" id="br_review_content" class="form-control"  rows="8" >${bReplyUpdate.br_review_content}</textarea>
													...
													<div class="col-md-12">
														<div class="single-form mt-25">
															<div>사진 첨부</div>
															<input type="file" id="file" name="file" value="${bReplyUpdate.br_review_file}"/>
														</div>
													</div>
