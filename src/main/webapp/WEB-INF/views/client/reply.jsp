										...
										<div class="container">
											...
											<div id="reply" class="reply">
													...
													<c:when test="${not empty replyList}"> --%>
														<thead class="head">
															<tr>
																...
																<th class="pd_review_insert">작성</th>
															</tr>
														</thead>
															<tbody>
																<%-- <c:forEach var="reply" items="${replyList}" varStatus="status"> --%>
																	<tr class="text-center" data-num="${replyList.pd_review_no}">
																		<td>
																			<c:if test="${not empty replyList.pd_review_thumb}">
																				<img src="/uploadStorage/reply/thumbnail/${replyList.pd_review_thumb}" />
																			</c:if>
																		</td>
																		<td>${replyList.pd_name}</td>
																		<td>${replyList.pd_review_content}</td>
																		<td>${replyList.pd_review_date}</td>
																		<td>
												...
												<%-- 				</c:forEach>
														...
														<c:otherwise>
															<tr>
																<td colspan="6" class="tac text-center">구매내역이 존재하지 않습니다.</td>
															</tr>
														</c:otherwise>
													</c:choose> --%>
												</tbody>
