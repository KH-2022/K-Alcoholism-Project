...
<html>
	<head>
		...
		<link type="text/css" rel="stylesheet" href="/resources/include/css/admin.css" />
	...
	<body>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-9 col-md-10 main"><!-- class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" -->
