		...
		<div class="contentContainer container">
			...
			<div class="contentTB text-center">
				<form id="f_updateForm" name="f_updateForm">
					...
					<input type="hidden" id="qna_file" name="qna_file" value="${updateData.qna_file}" />
					<input type="hidden" id="qna_thumb" name="qna_thumb" value="${updateData.qna_thumb}" />
					...
					<table class="table table-bordered">
						...
						<tbody>
							<tr>
								<td>글제목</td>
								<td class="text-left"><input type="text" name="qna_title" id="qna_title"  value="${updateData.qna_title}" class="form-control" /></td>
							</tr>
							<tr>
								<td>글내용</td>
								<td class="text-left"><textarea name="qna_content" id="qna_content" class="form-control" rows="8">${updateData.qna_content}</textarea></td>
							</tr>
							<tr>
								<td>파일첨부</td>
